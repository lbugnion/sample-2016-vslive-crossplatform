...
namespace ObservableListApple
{
    partial class CollectionViewController : UICollectionViewController
    {
        ...
        private ObservableCollectionViewSource<Item, TestCollectionViewCell> _source;
    ...
    public class CollectionViewSourceEx : ObservableCollectionViewSource<Item, TestCollectionViewCell>
    {
